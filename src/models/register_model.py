...
dagshub.init(repo_owner='AnandRaj16', 
             repo_name='delivery-time-prediction-system', 
             mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/AnandRaj16/delivery-time-prediction-system.mlflow")
...
if __name__ == "__main__":
    ...
    # MLflow 3 logs models as separate logged-model entities, so register
    # using the models:/<model_id> URI instead of the runs:/ path
    model_registry_path = f"models:/{model_id}"
